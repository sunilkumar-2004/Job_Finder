...
// import { apiRequest } from "../utils"; // adjust path if needed
// import { Login } from "../redux/actions/authActions"; // adjust path if needed
                    ...
                    <div className="w-full flex gap-2">
                      ...
                      >
                        <TextInput
                          ...
                          placeholder={
                            accountType === "seeker" ? "e.g. James" : "Company name"
                          }
                          type="text"
                          register={register(
                            accountType === "seeker"
